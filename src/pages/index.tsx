...
const InfoBlock = () => {
  return (
    <>
      ...
      <Typography mb={4}>Weitere Infos, <a href="https://www.hovawarte.com/impressum">Impressum</a> und <a href="https://www.hovawarte.com/verein/regionalgruppen/nord/og-hamburg/ansprechpartner">Kontaktmöglichkeiten</a> finden
        Sie auf der <a href="https://www.hovawarte.com/verein/regionalgruppen/nord/og-hamburg/ansprechpartner">Haupt-Webpräsenz des HZD</a>.</Typography>
